...
description: Long-form background notes
tags: ["reading"]
---

Explainers that sit alongside the generated OKF bundles.
...
- [MUDDI UK Excavation Profile — Deep Dive](/bundles/muddi/reading/uk-excavation-profile/)
  ...
  flattened inheritance and UK-specific attributes.

## MUDDI EXTENSIONS

Where the models are heading next.

- [Forward Works Plans: The Case for a Standard](forward-works-plans.md) — how
  NRSWA street-works coordination depends on shared forward planning, why that
  sharing stays voluntary today, and how a standard exchange format — and the
  coming MUDDI extension for forward plans and capacity — could improve it.
