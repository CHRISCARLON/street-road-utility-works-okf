---
type: Relationship
title: Networktosubordinatenetwork
description: The Networktosubordinatenetwork junction table linking MUDDI features
  via soft references.
resource: coredata.relationship_networktosubordinatenetwork
tags:
- relationship
- uk-excavation
...
| `linkedsubordinatenetworkid` | text | yes |  |
| `linkedsubordinatenetworktable` | text | yes |  |
