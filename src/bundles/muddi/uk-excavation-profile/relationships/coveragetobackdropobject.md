---
type: Relationship
title: Coveragetobackdropobject
description: The Coveragetobackdropobject junction table linking MUDDI features via
  soft references.
resource: coredata.relationship_coveragetobackdropobject
tags:
- relationship
- uk-excavation
...
| `coverageid` | text | yes |  |
| `backdropobjecttable` | text | yes |  |
| `backdropobjectid` | text | yes |  |
