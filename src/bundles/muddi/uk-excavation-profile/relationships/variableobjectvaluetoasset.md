---
type: Relationship
title: Variableobjectvaluetoasset
description: The Variableobjectvaluetoasset junction table linking MUDDI features
  via soft references.
resource: coredata.relationship_variableobjectvaluetoasset
tags:
- relationship
- uk-excavation
...
| `linkedvariableobjectvalueid` | text | yes |  |
| `linkedvariableobjectvaluetable` | text | yes |  |
