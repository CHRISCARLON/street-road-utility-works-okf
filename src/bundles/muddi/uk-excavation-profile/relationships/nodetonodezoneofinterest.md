---
type: Relationship
title: Nodetonodezoneofinterest
description: The Nodetonodezoneofinterest junction table linking MUDDI features via
  soft references.
resource: coredata.relationship_nodetonodezoneofinterest
tags:
- relationship
- uk-excavation
...
| `linkednodeid` | text | yes |  |
| `linkednodetable` | text | yes |  |
| `linkednodezoneofinterestid` | text | yes |  |
| `linkednodezoneofinteresttable` | text | yes |  |
