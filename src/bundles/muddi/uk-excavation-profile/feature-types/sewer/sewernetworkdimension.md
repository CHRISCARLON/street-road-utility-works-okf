...
title: Sewer Network Dimension
description: The Sewer Network Dimension feature table (coredata.sewernetworkdimension)
  in the MUDDI UK Excavation Profile.
resource: coredata.sewernetworkdimension
tags:
- sewer
- networkdimension
- uk-excavation
