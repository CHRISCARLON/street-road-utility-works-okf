...
title: Telecommunications Network Node
description: The Telecommunications Network Node feature table (coredata.telconetworknode)
  in the MUDDI UK Excavation Profile.
resource: coredata.telconetworknode
tags:
- telco
- networknode
- uk-excavation
