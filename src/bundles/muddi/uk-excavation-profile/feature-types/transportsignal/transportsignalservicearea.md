...
title: Transport Signal Service Area
description: The Transport Signal Service Area feature table (coredata.transportsignalservicearea)
  in the MUDDI UK Excavation Profile.
resource: coredata.transportsignalservicearea
tags:
- transportsignal
- servicearea
- uk-excavation
...
| `serviceareatype` | text |  | [serviceareatypevalue](/uk-excavation-profile/codelists/serviceareatypevalue.md) |
| `serviceareasubtype` | text |  |  |
| `nationalorregionalcoverage` | text | yes |  |
| `buffered` | boolean | yes |  |
...
Specialises [Service Area](/conceptual/service-area.md) in the MUDDI conceptual model.
