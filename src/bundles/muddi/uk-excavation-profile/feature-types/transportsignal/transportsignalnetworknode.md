...
title: Transport Signal Network Node
description: The Transport Signal Network Node feature table (coredata.transportsignalnetworknode)
  in the MUDDI UK Excavation Profile.
resource: coredata.transportsignalnetworknode
tags:
- transportsignal
- networknode
- uk-excavation
...
Specialises [Network Node](/conceptual/network-node.md) in the MUDDI conceptual model.
