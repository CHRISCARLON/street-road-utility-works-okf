...
title: Transport Signal Support Object
description: The Transport Signal Support Object feature table (coredata.transportsignalsupportobject)
  in the MUDDI UK Excavation Profile.
resource: coredata.transportsignalsupportobject
tags:
- transportsignal
- supportobject
- uk-excavation
...
| `accessorytype` | text |  |  |
| `supporttype` | text |  | [supporttypevalue](/uk-excavation-profile/codelists/supporttypevalue.md) |
| `supportsubtype` | text |  |  |
| `dataproviderid_fk` | character varying(38) | yes | [organisation](/uk-excavation-profile/feature-types/shared/organisation.md) |

# Conceptual type

Specialises [Support Object](/conceptual/network-accessory.md) in the MUDDI conceptual model.
