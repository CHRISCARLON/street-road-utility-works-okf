...
title: Transport Signal Container Object
description: The Transport Signal Container Object feature table (coredata.transportsignalcontainerobject)
  in the MUDDI UK Excavation Profile.
resource: coredata.transportsignalcontainerobject
tags:
- transportsignal
- containerobject
- uk-excavation
...
| `accessorytype` | text |  |  |
| `containertype` | text |  | [containertypevalue](/uk-excavation-profile/codelists/containertypevalue.md) |
...
Specialises [Container Object](/conceptual/network-conveyance.md) in the MUDDI conceptual model.
