...
title: Backdroptext
description: The Backdroptext feature table (custombackdrop.backdroptext) in the MUDDI
  UK Excavation Profile.
resource: custombackdrop.backdroptext
tags:
- shared
- uk-excavation
