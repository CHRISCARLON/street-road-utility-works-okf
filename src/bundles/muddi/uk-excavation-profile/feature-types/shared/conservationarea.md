...
title: Conservationarea
description: The Conservationarea feature table (coredata.conservationarea) in the
  MUDDI UK Excavation Profile.
resource: coredata.conservationarea
tags:
- shared
- uk-excavation
...
| `policyname` | text |  |  |
| `designationpurpose` | text |  | [designationpurposevalue](/uk-excavation-profile/codelists/designationpurposevalue.md) |
