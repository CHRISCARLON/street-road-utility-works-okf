...
title: Backdropraster
description: The Backdropraster feature table (custombackdrop.backdropraster) in the
  MUDDI UK Excavation Profile.
resource: custombackdrop.backdropraster
tags:
- shared
- uk-excavation
...
| `mimetype` | text | yes |  |
| `fullpath` | text | yes |  |
| `extent` | geometry(GEOMETRY,27700) | yes |  |
