...
title: Fuel & Chemicals Network Link
description: The Fuel & Chemicals Network Link feature table (coredata.fuelandchemicalsnetworklink)
  in the MUDDI UK Excavation Profile.
resource: coredata.fuelandchemicalsnetworklink
tags:
- fuelandchemicals
- networklink
- uk-excavation
...
Specialises [Network Link](/conceptual/network-link.md) in the MUDDI conceptual model.
