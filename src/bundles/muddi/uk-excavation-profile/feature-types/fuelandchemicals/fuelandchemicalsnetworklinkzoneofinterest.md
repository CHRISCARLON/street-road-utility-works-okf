...
title: Fuel & Chemicals Network Link Zone of Interest
description: The Fuel & Chemicals Network Link Zone of Interest feature table (coredata.fuelandchemicalsnetworklinkzoneofinterest)
  in the MUDDI UK Excavation Profile.
resource: coredata.fuelandchemicalsnetworklinkzoneofinterest
tags:
- fuelandchemicals
...
| `conveyancecategory` | text |  | [conveyancecategoryvalue](/uk-excavation-profile/codelists/conveyancecategoryvalue.md) |
| `conveyancemethod` | text |  | [conveyancemethodvalue](/uk-excavation-profile/codelists/conveyancemethodvalue.md) |
| `fillmaterial` | text |  |  |
| `operatingconveyancelevel` | real |  |  |
| `operatingconveyanceleveltype` | text |  | [operatingconveyanceleveltypevalue](/uk-excavation-profile/codelists/operatingconveyanceleveltypevalue.md) |
...
| `materialgrade` | text |  | [materialgradevalue](/uk-excavation-profile/codelists/materialgradevalue.md) |
| `slabbing` | boolean |  |  |
| `tape` | boolean |  |  |
| `mahp` | boolean |  |  |
...
Specialises [Network Link Zone of Interest](/conceptual/muddi-space.md) in the MUDDI conceptual model.
